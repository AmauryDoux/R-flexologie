            ...
            this.getLocaleConfig = function (fullCalendarConfig) {
                if (!fullCalendarConfig.lang && !fullCalendarConfig.locale || fullCalendarConfig.useNgLocale) {
                    ...
                    var dtf = $locale.DATETIME_FORMATS,
                        month = ['janvier', 'fevrier', 'mars', 'avril', 'mai', 'juin', 'juillet', 'aout', 'septembre', 'octobre', 'novembe', 'decembre'],
                        shortmonth = ['jan', 'fev', 'mar', 'avr', 'mai', 'jui', 'jui', 'aou', 'sep', 'oct', 'nov', 'dec'],
                        day = ['Dimanche', 'Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'vendredi', 'Samedi'],
                        shortday = ['Dim','Lun', 'Mar', 'Mer', 'Jeu', 'ven', 'Sam']

                    return {
                        monthNames: tValues(month),
                        monthNamesShort: tValues(shortmonth),
                        dayNames: tValues(day),
                        dayNamesShort: tValues(shortday)
                    };
                }
